...
export default function Pageastrazionisimboliche19781985() {
  return (
    <div className="wp-singular page-template page-template-page-templates page-template-template-pagebuilder-full-width page-template-page-templatestemplate-pagebuilder-full-width-php page page-id-3887 wp-theme-neve  nv-blog-default nv-sidebar-full-width menu_sidebar_slide_left elementor-default elementor-kit-14 elementor-page elementor-page-3887 nv-template">
...
<link rel="stylesheet" id="elementor-post-3887-css" href="/css/post-3887.css" media="all">
...
/*# sourceURL=/wp-includes/blocks/social-links/style.min.css */
 ...
 ` }} />
      <Script strategy="afterInteractive" src="/js/en/astrazioni-simboliche-1978-1985-logic.js" />
...
<ul class="sub-menu">
	...
	<li id="menu-item-3892" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3887 current_page_item menu-item-3892 nv-active"><div class="wrap"><a href="/en/astrazioni-simboliche-1978-1985/" aria-current="page">1978-1985 Symbolic Abstractions</a></div></li>
...
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-3887 current_page_item menu-item-3892 nv-active"><div class="wrap"><a href="/en/astrazioni-simboliche-1978-1985/" aria-current="page">1978-1985 Symbolic Abstractions</a></div></li>
...
<td>
<p style="text-align: left; margin-left: -15px;">1978 – 1985<br>
<strong>SYMBOLIC ABSTRACTIONS</strong></p>
</td>
</tr>
</tbody>
</table>						</div>
...
<td>
<p style="margin-left: -15px;">They are bronze projects and models for large outdoor sculptures. Their plastic themes 
refer to some archetypes of symbolic figuration: the idea of "Fertility and Maternity", 
of the "Masculine and the Feminine", of the "Regeneration and Rebirth", the "Masks of the Sacred" and other symbols and figurations in the history and narrative of sculpture.
                            ...
                            <tbody><tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="1" onclick="myBorder('1')">
                                        <img decoding="async" src="/images/01ASX.jpg" style="display:none;" id="img1" alt="01">
                                        <img decoding="async" style="width: 80px;" src="/images/01AS.jpg" onclick="myFunction('img1');">
                                    </div>
                                       
                                </td>
                                <td>
                                    <div class="column_img" id="2" onclick="myBorder('2')">   
										<img decoding="async" src="/images/02ASX.jpg" style="display:none;" id="img2" alt="02">
                                        <img decoding="async" style="width: 80px;" src="/images/02AS.jpg" onclick="myFunction('img2');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="3" onclick="myBorder('3')">   
										<img decoding="async" src="/images/03ASX.jpg" style="display:none;" id="img3" alt="03" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/03AS.jpg" onclick="myFunction('img3');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="4" onclick="myBorder('4')">   
										<img decoding="async" src="/images/04ASX.jpg" style="display:none;" id="img4" alt="04" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/04AS.jpg" onclick="myFunction('img4');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="5" onclick="myBorder('5')"> 
										<img decoding="async" src="/images/05ASX.jpg" style="display:none;" id="img5" alt="05" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/05AS.jpg" onclick="myFunction('img5');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="6" onclick="myBorder('6')">
                                        <img decoding="async" src="/images/06ASX.jpg" style="display:none;" id="img6" alt="06" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/06AS.jpg" onclick="myFunction('img6');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="7" onclick="myBorder('7')">
                                        <img decoding="async" src="/images/07ASX.jpg" style="display:none;" id="img7" alt="07" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/07AS.jpg" onclick="myFunction('img7');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="8" onclick="myBorder('8')">
                                        <img decoding="async" src="/images/08ASX.jpg" style="display:none;" id="img8" alt="08" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/08AS.jpg" onclick="myFunction('img8');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="9" onclick="myBorder('9')">
                                        <img decoding="async" src="/images/09ASX.jpg" style="display:none;" id="img9" alt="09" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/09AS.jpg" onclick="myFunction('img9');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="10" onclick="myBorder('10')">
                                        <img decoding="async" src="/images/10ASX.jpg" style="display:none;" id="img10" alt="10" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/10AS.jpg" onclick="myFunction('img10');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="11" onclick="myBorder('11')">
                                        <img decoding="async" src="/images/11ASX.jpg" style="display:none;" id="img11" alt="11" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/11AS.jpg" onclick="myFunction('img11');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="12" onclick="myBorder('12')">
                                        <img decoding="async" src="/images/12ASX.jpg" style="display:none;" id="img12" alt="12" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/12AS.jpg" onclick="myFunction('img12');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="13" onclick="myBorder('13')">
                                        <img decoding="async" src="/images/13ASX.jpg" style="display:none;" id="img13" alt="13" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/13AS.jpg" onclick="myFunction('img13');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="14" onclick="myBorder('14')">
                                        <img decoding="async" src="/images/14ASX.jpg" style="display:none;" id="img14" alt="14" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/14AS.jpg" onclick="myFunction('img14');">
                                    </div>
                                </td>
                            </tr>
                        </tbody></table>
                            ...
                            <tbody><tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="15" onclick="myBorder('15')">
                                        <img decoding="async" src="/images/15ASX.jpg" style="display:none;" id="img15" alt="15" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/15AS.jpg" onclick="myFunction('img15');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="16" onclick="myBorder('16')">
                                        <img decoding="async" src="/images/16ASX.jpg" style="display:none;" id="img16" alt="16" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/16AS.jpg" onclick="myFunction('img16');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="17" onclick="myBorder('17')">
                                        <img decoding="async" src="/images/17ASX.jpg" style="display:none;" id="img17" alt="17" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/17AS.jpg" onclick="myFunction('img17');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="18" onclick="myBorder('18')">
                                        <img decoding="async" src="/images/18ASX.jpg" style="display:none;" id="img18" alt="18" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/18AS.jpg" onclick="myFunction('img18');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="19" onclick="myBorder('19')">
                                        <img decoding="async" src="/images/19ASX.jpg" style="display:none;" id="img19" alt="19" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/19AS.jpg" onclick="myFunction('img19');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="20" onclick="myBorder('20')">
                                        <img decoding="async" src="/images/20ASX.jpg" style="display:none;" id="img20" alt="20" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/20AS.jpg" onclick="myFunction('img20');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="21" onclick="myBorder('21')">
                                        <img decoding="async" src="/images/21ASX.jpg" style="display:none;" id="img21" alt="21" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/21AS.jpg" onclick="myFunction('img21');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="22" onclick="myBorder('22')">
                                        <img decoding="async" src="/images/22ASX.jpg" style="display:none;" id="img22" alt="22" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/22AS.jpg" onclick="myFunction('img22');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="23" onclick="myBorder('23')">
                                        <img decoding="async" src="/images/23ASX.jpg" style="display:none;" id="img23" alt="23" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/23AS.jpg" onclick="myFunction('img23');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="24" onclick="myBorder('24')">
                                        <img decoding="async" src="/images/24ASX.jpg" style="display:none;" id="img24" alt="24" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/24AS.jpg" onclick="myFunction('img24');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_gri" id="25" onclick="myBorder('25')">
                                        <img decoding="async" src="/images/25ASX.jpg" style="display:none;" id="img25" alt="25" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/25AS.jpg" onclick="myFunction('img25');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_gri" id="26" onclick="myBorder('26')">
                                        <img decoding="async" src="/images/26ASX.jpg" style="display:none;" id="img26" alt="26" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/26AS.jpg" onclick="myFunction('img26');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_gri" id="27" onclick="myBorder('27')">
                                        <img decoding="async" src="/images/27ASX.jpg" style="display:none;" id="img27" alt="27" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/27AS.jpg" onclick="myFunction('img27');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_gri" id="28" onclick="myBorder('28')">
                                        <img decoding="async" src="/images/28ASX.jpg" style="display:none;" id="img28" alt="28" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/28AS.jpg" onclick="myFunction('img28');">
                                    </div>
                                </td>
                            </tr>
                        </tbody></table>
...
1964-1977</a>						</div>
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
							<a href="/en/geometrie-elementari-1986-1997">Geometries 
Elementary<br>
1986-1997</a>						</div>
				</div>
					</div>
