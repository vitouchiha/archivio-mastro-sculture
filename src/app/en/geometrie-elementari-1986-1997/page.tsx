...
export default function Pagegeometrieelementari19861997() {
  return (
    <div className="wp-singular page-template page-template-page-templates page-template-template-pagebuilder-full-width page-template-page-templatestemplate-pagebuilder-full-width-php page page-id-4126 wp-theme-neve  nv-blog-default nv-sidebar-full-width menu_sidebar_slide_left elementor-default elementor-kit-14 elementor-page elementor-page-4126 nv-template">
...
<link rel="stylesheet" id="elementor-post-4126-css" href="/css/post-4126.css" media="all">
...
/*# sourceURL=/wp-includes/blocks/social-links/style.min.css */
 ...
 ` }} />
      <Script strategy="afterInteractive" src="/js/en/geometrie-elementari-1986-1997-logic.js" />
...
<ul class="sub-menu">
	...
	<li id="menu-item-4131" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-4126 current_page_item menu-item-4131 nv-active"><div class="wrap"><a href="/en/geometrie-elementari-1986-1997/" aria-current="page">1986-1997 Elementary Geometries</a></div></li>
...
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-4126 current_page_item menu-item-4131 nv-active"><div class="wrap"><a href="/en/geometrie-elementari-1986-1997/" aria-current="page">1986-1997 Elementary Geometries</a></div></li>
...
<td>
<p style="text-align: left; margin-left: -15px;">1986 – 1997<br>
<strong>ELEMENTARY GEOMETRIES</strong></p>
</td>
</tr>
</tbody>
</table>						</div>
				...
				<div class="elementor-widget-container">
							<p>In continuity with the plastic research of the 70s and 80s, these works are studies for sculptures in stone or bronze, designed for large outdoor spaces. Even more abstract and linear than the previous ones, they seek, in the purity and beauty of the geometric sign, the "elementary geometries", the "evocative", the "universals" in the story of the signs and symbols of figuration.</p>						</div>
				</div>
					</div>
		</div>
					</div>
    ...
    <title>Scheme</title>
       <style>   
                            ...
                            <tbody><tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="1" onclick="myBorder('1')">
                                        <img decoding="async" src="/images/GEX01.jpg" style="display:none;" id="img1" alt="01">
                                        <img decoding="async" style="width: 80px;" src="/images/GE01.jpg" onclick="myFunction('img1');">
                                    </div>
                                       
                                </td>
                                <td>
                                    <div class="column_img" id="2" onclick="myBorder('2')">   
										<img decoding="async" src="/images/GEX02.jpg" style="display:none;" id="img2" alt="02">
                                        <img decoding="async" style="width: 80px;" src="/images/GE02.jpg" onclick="myFunction('img2');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="3" onclick="myBorder('3')">   
										<img decoding="async" src="/images/GEX03.jpg" style="display:none;" id="img3" alt="03" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE03.jpg" onclick="myFunction('img3');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="4" onclick="myBorder('4')">   
										<img decoding="async" src="/images/GEX04.jpg" style="display:none;" id="img4" alt="04" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE04.jpg" onclick="myFunction('img4');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="5" onclick="myBorder('5')"> 
										<img decoding="async" src="/images/GEX05.jpg" style="display:none;" id="img5" alt="05" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE05.jpg" onclick="myFunction('img5');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="6" onclick="myBorder('6')">
                                        <img decoding="async" src="/images/GEX06.jpg" style="display:none;" id="img6" alt="06" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE06.jpg" onclick="myFunction('img6');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="7" onclick="myBorder('7')">
                                        <img decoding="async" src="/images/GEX07.jpg" style="display:none;" id="img7" alt="07" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE07.jpg" onclick="myFunction('img7');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="8" onclick="myBorder('8')">
                                        <img decoding="async" src="/images/GEX08.jpg" style="display:none;" id="img8" alt="08" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE08.jpg" onclick="myFunction('img8');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="9" onclick="myBorder('9')">
                                        <img decoding="async" src="/images/GEX09.jpg" style="display:none;" id="img9" alt="09" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE09.jpg" onclick="myFunction('img9');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="10" onclick="myBorder('10')">
                                        <img decoding="async" src="/images/GEX10.jpg" style="display:none;" id="img10" alt="10" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE10.jpg" onclick="myFunction('img10');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="11" onclick="myBorder('11')">
                                        <img decoding="async" src="/images/GEX11.jpg" style="display:none;" id="img11" alt="11" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE11.jpg" onclick="myFunction('img11');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="12" onclick="myBorder('12')">
                                        <img decoding="async" src="/images/GEX12.jpg" style="display:none;" id="img12" alt="12" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE12.jpg" onclick="myFunction('img12');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="13" onclick="myBorder('13')">
                                        <img decoding="async" src="/images/GEX13.jpg" style="display:none;" id="img13" alt="13" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE13.jpg" onclick="myFunction('img13');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="14" onclick="myBorder('14')">
                                        <img decoding="async" src="/images/GEX14.jpg" style="display:none;" id="img14" alt="14" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE14.jpg" onclick="myFunction('img14');">
                                    </div>
                                </td>
                            </tr>
                        </tbody></table>
                            ...
                            <tbody><tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="15" onclick="myBorder('15')">
                                        <img decoding="async" src="/images/GEX15.jpg" style="display:none;" id="img15" alt="15" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE15.jpg" onclick="myFunction('img15');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="16" onclick="myBorder('16')">
                                        <img decoding="async" src="/images/GEX16.jpg" style="display:none;" id="img16" alt="16" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE16.jpg" onclick="myFunction('img16');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="17" onclick="myBorder('17')">
                                        <img decoding="async" src="/images/GEX17.jpg" style="display:none;" id="img17" alt="17" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE17.jpg" onclick="myFunction('img17');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="18" onclick="myBorder('18')">
                                        <img decoding="async" src="/images/GEX18B.jpg" style="display:none;" id="img18" alt="18" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE18B.jpg" onclick="myFunction('img18');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="19" onclick="myBorder('19')">
                                        <img decoding="async" src="/images/GEX19.jpg" style="display:none;" id="img19" alt="19" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE19.jpg" onclick="myFunction('img19');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="20" onclick="myBorder('20')">
                                        <img decoding="async" src="/images/GEX20.jpg" style="display:none;" id="img20" alt="20" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE20.jpg" onclick="myFunction('img20');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="21" onclick="myBorder('21')">
                                        <img decoding="async" src="/images/GEX21.jpg" style="display:none;" id="img21" alt="21" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE21.jpg" onclick="myFunction('img21');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="22" onclick="myBorder('22')">
                                        <img decoding="async" src="/images/GEX22.jpg" style="display:none;" id="img22" alt="22" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE22.jpg" onclick="myFunction('img22');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="23" onclick="myBorder('23')">
                                        <img decoding="async" src="/images/GEX23.jpg" style="display:none;" id="img23" alt="23" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE23.jpg" onclick="myFunction('img23');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="24" onclick="myBorder('24')">
                                        <img decoding="async" src="/images/GEX24.jpg" style="display:none;" id="img24" alt="24" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE24.jpg" onclick="myFunction('img24');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_gri" id="25" onclick="myBorder('25')">
                                        <img decoding="async" src="/images/GEX25.jpg" style="display:none;" id="img25" alt="25" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE25.jpg" onclick="myFunction('img25');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_gri" id="26" onclick="myBorder('26')">
                                        <img decoding="async" src="/images/GEX26.jpg" style="display:none;" id="img26" alt="26" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE26.jpg" onclick="myFunction('img26');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_gri" id="27" onclick="myBorder('27')">
                                        <img decoding="async" src="/images/GEX27B.jpg" style="display:none;" id="img27" alt="27" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE27.jpg" onclick="myFunction('img27');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_gri" id="28" onclick="myBorder('28')">
                                        <img decoding="async" src="/images/GEX28.jpg" style="display:none;" id="img28" alt="28" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/GE28.jpg" onclick="myFunction('img28');">
                                    </div>
                                </td>
                            </tr>
                        </tbody></table>
            ...
            <table height="100px" padding="0px" margin="0px" style="width: 1000px; border: 0px;"> <!-- Tabella Riquadri Immagini-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-52668f5 elementor-section-full_width sezionetitoli elementor-section-height-default elementor-section-height-default" data-id="52668f5" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-0bc47e7" data-id="0bc47e7" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-3c5738c titoli_opere elementor-widget elementor-widget-text-editor" data-id="3c5738c" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
1964-1977</a>						</div>
				...
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-caf10bf colonnatitoli" data-id="caf10bf" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-ac550eb" data-id="ac550eb" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-61ca0a0 titoli_opere elementor-widget elementor-widget-text-editor" data-id="61ca0a0" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
1978-1985</a>						</div>
				...
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-aaf6c2c colonnatitoli" data-id="aaf6c2c" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-8c48f48" data-id="8c48f48" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-db344df titoli_opere elementor-widget elementor-widget-text-editor" data-id="db344df" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
1998-2004 I</a>						</div>
				...
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-c7e1952 colonnatitoli" data-id="c7e1952" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-a4512b7" data-id="a4512b7" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-3e26f8b titoli_opere elementor-widget elementor-widget-text-editor" data-id="3e26f8b" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
1998-2004 II</a>						</div>
				...
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-d7b2749 colonnatitoli" data-id="d7b2749" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-969cdcf" data-id="969cdcf" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-280c28d titoli_opere elementor-widget elementor-widget-text-editor" data-id="280c28d" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
<p>Archivio Mastro Sculture - Viale A. Oriani 36, 40137 Bologna - email: <a href="mailto:mastroronzo@gmail.com">mastroronzo@gmail.com</a> Tax code MSTRNZ49T30E205O</p>
</div>	</div>
	</div>
