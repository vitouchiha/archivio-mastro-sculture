...
export default function Pagepresentazione() {
  return (
    <div className="wp-singular page-template page-template-page-templates page-template-template-pagebuilder-full-width page-template-page-templatestemplate-pagebuilder-full-width-php page page-id-58 wp-theme-neve  nv-blog-default nv-sidebar-full-width menu_sidebar_slide_left elementor-default elementor-kit-14 elementor-page elementor-page-58 nv-template">
...
<link rel="stylesheet" id="elementor-post-58-css" href="/css/post-58.css" media="all">
...
<li id="menu-item-68" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-58 current_page_item menu-item-68 nv-active"><div class="wrap"><a href="/en/presentazione/" aria-current="page">Presentation</a></div></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-58 current_page_item menu-item-68 nv-active"><div class="wrap"><a href="/en/presentazione/" aria-current="page">Presentation</a></div></li>
...
.elementor-column .elementor-spacer-inner{height:var(--spacer-size)}.e-con{--container-widget-width:100%}.e-con-inner>.elementor-widget-spacer,.e-con>.elementor-widget-spacer{width:var(--container-widget-width,var(--spacer-size));--align-self:var(--container-widget-align-self,initial);--flex-shrink:0}.e-con-inner>.elementor-widget-spacer>.elementor-widget-container,.e-con>.elementor-widget-spacer>.elementor-widget-container{height:100%;width:100%}.e-con-inner>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer,.e-con>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer{height:100%}.e-con-inner>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer>.elementor-spacer-inner,.e-con>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer>.elementor-spacer-inner{height:var(--container-widget-height,var(--spacer-size))}.e-con-inner>.elementor-widget-spacer.elementor-widget-empty,.e-con>.elementor-widget-spacer.elementor-widget-empty{position:relative;min-height:22px;min-width:22px}.e-con-inner>.elementor-widget-spacer.elementor-widget-empty .elementor-widget-empty-icon,.e-con>.elementor-widget-spacer.elementor-widget-empty .elementor-widget-empty-icon{position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;padding:0;width:22px;height:22px}</style>		<div class="elementor-spacer">
			<div class="elementor-spacer-inner"></div>
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-1d1c9d1 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="1d1c9d1" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-59c506d" data-id="59c506d" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-ffea4cc" data-id="ffea4cc" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
			...
			<div class="elementor-spacer-inner"></div>
				...
				<div class="elementor-widget-container">
			<style>/*! elementor - v3.23.0 - 15-07-2024 */
.elementor-widget-image{text-align:center}.elementor-widget-image a{display:inline-block}.elementor-widget-image a img[src\\\\\\\\$=".svg"]{width:48px}.elementor-widget-image img{vertical-align:middle;display:inline-block}</style>										<img loading="lazy" decoding="async" width="1024" height="272" src="/images/presentazione_01-1024x272.png" class="attachment-large size-large wp-image-558" alt="presentazione_01" srcset="/images/presentazione_01-1024x272.png 1024w, /images/presentazione_01-300x80.png 300w, /images/presentazione_01-768x204.png 768w, /images/presentazione_01.png 1244w" sizes="(max-width: 1024px) 100vw, 1024px">													</div>
				</div>
			...
			<div class="elementor-spacer-inner"></div>
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-a1322c3 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="a1322c3" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-b9ef6c6" data-id="b9ef6c6" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-9b55e04" data-id="9b55e04" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
			...
			<div class="elementor-spacer-inner"></div>
				...
				<div class="elementor-widget-container">
			<style>/*! elementor - v3.23.0 - 15-07-2024 */
.elementor-widget-text-editor.elementor-drop-cap-view-stacked .elementor-drop-cap{background-color:#69727d;color:#fff}.elementor-widget-text-editor.elementor-drop-cap-view-framed .elementor-drop-cap{color:#69727d;border:3px solid;background-color:transparent}.elementor-widget-text-editor:not(.elementor-drop-cap-view-default) .elementor-drop-cap{margin-top:8px}.elementor-widget-text-editor:not(.elementor-drop-cap-view-default) .elementor-drop-cap-letter{width:1em;height:1em}.elementor-widget-text-editor .elementor-drop-cap{float:left;text-align:center;line-height:1;font-size:50px}.elementor-widget-text-editor .elementor-drop-cap-letter{display:inline-block}</style>				<p><strong>My history, my sculpture</strong></p>						</div>
				</div>
					</div>
		</div>
					</div>
			...
			<div class="elementor-spacer-inner"></div>
				...
				<div class="elementor-element elementor-element-860e0a8 elementor-widget elementor-widget-text-editor" data-id="860e0a8" data-element_type="widget" data-widget_type="text-editor.default">In the late seventies I asked myself whether the discourse on sculpture, carried forward by Constantin Brancusi, Arturo Martini and Fausto Melotti, could have a continuation.<br>I wondered if their works, besides being what they are and what they say, were also a path to follow towards innovation in the tradition of plastic language.<br>I wondered if the artists of my time were missing something regarding the lesson of the masters of the early twentieth century.</div>
				<div class="elementor-element elementor-element-b98edf8 elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="b98edf8" data-element_type="widget" data-widget_type="divider.default">
				<div class="elementor-widget-container">
			<style>/*! elementor - v3.23.0 - 15-07-2024 */
.elementor-widget-divider{--divider-border-style:none;--divider-border-width:1px;--divider-color:#0c0d0e;--divider-icon-size:20px;--divider-element-spacing:10px;--divider-pattern-height:24px;--divider-pattern-size:20px;--divider-pattern-url:none;--divider-pattern-repeat:repeat-x}.elementor-widget-divider .elementor-divider{display:flex}.elementor-widget-divider .elementor-divider__text{font-size:15px;line-height:1;max-width:95%}.elementor-widget-divider .elementor-divider__element{margin:0 var(--divider-element-spacing);flex-shrink:0}.elementor-widget-divider .elementor-icon{font-size:var(--divider-icon-size)}.elementor-widget-divider .elementor-divider-separator{display:flex;margin:0;direction:ltr}.elementor-widget-divider--view-line_icon .elementor-divider-separator,.elementor-widget-divider--view-line_text .elementor-divider-separator{align-items:center}.elementor-widget-divider--view-line_icon .elementor-divider-separator:after,.elementor-widget-divider--view-line_icon .elementor-divider-separator:before,.elementor-widget-divider--view-line_text .elementor-divider-separator:after,.elementor-widget-divider--view-line_text .elementor-divider-separator:before{display:block;content:"";border-block-end:0;flex-grow:1;border-block-start:var(--divider-border-width) var(--divider-border-style) var(--divider-color)}.elementor-widget-divider--element-align-left .elementor-divider .elementor-divider-separator>.elementor-divider__svg:first-of-type{flex-grow:0;flex-shrink:100}.elementor-widget-divider--element-align-left .elementor-divider-separator:before{content:none}.elementor-widget-divider--element-align-left .elementor-divider__element{margin-left:0}.elementor-widget-divider--element-align-right .elementor-divider .elementor-divider-separator>.elementor-divider__svg:last-of-type{flex-grow:0;flex-shrink:100}.elementor-widget-divider--element-align-right .elementor-divider-separator:after{content:none}.elementor-widget-divider--element-align-right .elementor-divider__element{margin-right:0}.elementor-widget-divider--element-align-start .elementor-divider .elementor-divider-separator>.elementor-divider__svg:first-of-type{flex-grow:0;flex-shrink:100}.elementor-widget-divider--element-align-start .elementor-divider-separator:before{content:none}.elementor-widget-divider--element-align-start .elementor-divider__element{margin-inline-start:0}.elementor-widget-divider--element-align-end .elementor-divider .elementor-divider-separator>.elementor-divider__svg:last-of-type{flex-grow:0;flex-shrink:100}.elementor-widget-divider--element-align-end .elementor-divider-separator:after{content:none}.elementor-widget-divider--element-align-end .elementor-divider__element{margin-inline-end:0}.elementor-widget-divider:not(.elementor-widget-divider--view-line_text):not(.elementor-widget-divider--view-line_icon) .elementor-divider-separator{border-block-start:var(--divider-border-width) var(--divider-border-style) var(--divider-color)}.elementor-widget-divider--separator-type-pattern{--divider-border-style:none}.elementor-widget-divider--separator-type-pattern.elementor-widget-divider--view-line .elementor-divider-separator,.elementor-widget-divider--separator-type-pattern:not(.elementor-widget-divider--view-line) .elementor-divider-separator:after,.elementor-widget-divider--separator-type-pattern:not(.elementor-widget-divider--view-line) .elementor-divider-separator:before,.elementor-widget-divider--separator-type-pattern:not([class*=elementor-widget-divider--view]) .elementor-divider-separator{width:100%;min-height:var(--divider-pattern-height);-webkit-mask-size:var(--divider-pattern-size) 100%;mask-size:var(--divider-pattern-size) 100%;-webkit-mask-repeat:var(--divider-pattern-repeat);mask-repeat:var(--divider-pattern-repeat);background-color:var(--divider-color);-webkit-mask-image:var(--divider-pattern-url);mask-image:var(--divider-pattern-url)}.elementor-widget-divider--no-spacing{--divider-pattern-size:auto}.elementor-widget-divider--bg-round{--divider-pattern-repeat:round}.rtl .elementor-widget-divider .elementor-divider__text{direction:rtl}.e-con-inner>.elementor-widget-divider,.e-con>.elementor-widget-divider{width:var(--container-widget-width,100%);--flex-grow:var(--container-widget-flex-grow)}</style>		<div class="elementor-divider">
			<span class="elementor-divider-separator">
				...
				<div class="elementor-element elementor-element-b2c1cb8 elementor-widget elementor-widget-text-editor" data-id="b2c1cb8" data-element_type="widget" data-widget_type="text-editor.default">Let's take a step back: in 1972, after completing the Sculpture course at the Academy of Fine Arts in Florence, I made a choice regarding the artistic trends of my time. I chose craftsmanship and traditional techniques over the more abstract and conceptual expressions of those years. This choice was not against the new frontiers of aesthetic research (Performance Art, Arte Povera, Pop Art, Video Art, and others), but rather in favor of a tactile, manual experience that has shaped the history of figuration. It was a formative choice for me, having grown up in my father's ceramic workshop in Grottaglie and matured at the Academy in Florence, 'in the school' of the great Renaissance masters.</div>
				<div class="elementor-element elementor-element-69d6ac5 elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="69d6ac5" data-element_type="widget" data-widget_type="divider.default">
				<div class="elementor-widget-container">
			...
			<span class="elementor-divider-separator">
				...
				<div class="elementor-element elementor-element-6979cc8 elementor-widget elementor-widget-text-editor" data-id="6979cc8" data-element_type="widget" data-widget_type="text-editor.default">Returning to the cultural landscape of my time, in the second half of the 1970s, Bonito Oliva, with his Transavantgarde, theorized a return to manual skills, and Paolo Portoghesi, in 1980 with his Strada Novissima at the Venice Architecture Biennale, gave shape and substance to that aesthetic and philosophical movement called Postmodernism. I somewhat saw myself in that 'present looking at the past.'<br><span style="letter-spacing: var(--bodyletterspacing); text-transform: var(--bodytexttransform);">In those years of professional and artistic growth, I won two National Competitions for Public Works and participated in the Rome Quadriennale in 1975. Later, teaching—the art of knowing and knowing how to communicate the knowledge of art—broadened the horizons of my aesthetic research; studying, teaching, and working in the foundry did not leave me much time for exhibitions or competitions. I had to choose between being a full-time artist or artisan, and teaching as a profession; perhaps carrying forward my discourse on sculpture free from the constraints of the art market.</span></div>
				<div class="elementor-element elementor-element-de08891 elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="de08891" data-element_type="widget" data-widget_type="divider.default">
				<div class="elementor-widget-container">
					<div class="elementor-divider">
			<span class="elementor-divider-separator">
						</span>
				...
				<div class="elementor-element elementor-element-45b2ca0 elementor-widget elementor-widget-text-editor" data-id="45b2ca0" data-element_type="widget" data-widget_type="text-editor.default">That being said, let's return to the innovation within the tradition of plastic language. Let's return to Brancusi, Martini, and Melotti, master sculptors of 'timeless' art, for at least two reasons: the first relates to the alignment with the semantic register of what history and human feeling have always recognized as plastic art, the millennial and universal art of sculpture; the second relates to the tactile approach—reasoned and manual—of their way of expressing, thinking, and creating sculpture. Thus, with a certain pride, I know I am in line with that spiritual premise that seeks an idea or a narrative to represent through the mastery of the material.<br><span style="letter-spacing: var(--bodyletterspacing); text-transform: var(--bodytexttransform);">As I said before, in the late seventies, I thought that sculpture as research and teaching as a profession would be enough. Instead, teaching and its theoretical issues, along with sculpture in the narrative of the sacred and the symbolic, became the aesthetic experience in which I still see myself. For forty years (albeit discontinuously) I have sought 'simple forms', the 'spiritual', the 'universals' within the narrative and forms of sculpture. I have looked for the roots of the sacred and the meaning of my sculpture in the beauty and rigor of geometric signs.<br></span><span style="letter-spacing: var(--bodyletterspacing); text-transform: var(--bodytexttransform);">For forty years I taught the knowledge and forms of the language of images, a professional experience that made me grow as a teacher and as a person. However, I have always been a sculptor—or at least felt like one—until I realized that to truly be one I had to look at the roots and the history of sculpture, I had to look at its millennial narrative. I had a project to develop, but I needed time; I knew what to do, but I was slow. I was slow, ambitious, and outside the art market.</span></div>
				<div class="elementor-element elementor-element-381aca0 elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="381aca0" data-element_type="widget" data-widget_type="divider.default">
				<div class="elementor-widget-container">
					<div class="elementor-divider">
			<span class="elementor-divider-separator">
						</span>
				...
				<div class="elementor-element elementor-element-e0ab102 elementor-widget elementor-widget-text-editor" data-id="e0ab102" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
							<p>In the eighties and nineties I designed, modeled and then created, in polyester and bronze, models for sculptures to be enlarged in travertine, granite or bronze. They are my "finished", "completed" sculpture, since even just a model or a project can be enough when you don't have the means to enlarge. When, due to one's own limitations or by choice, one is outside that exclusive circle - cultural and commercial - which is the world of art. In addition to these iconic, abstract, totemic sculptures, between the 1980s and 2000s, I completed a cycle of smaller, linear, light works, almost like drawings suspended in the air. Made of cold-worked brass, they are figurations, stories and much more. They are my free sculpture, my "free song", in the register and lexicon of this ancient art.</p>						</div>
				</div>
				<div class="elementor-element elementor-element-de89a2c elementor-widget-divider--view-line elementor-widget elementor-widget-divider" data-id="de89a2c" data-element_type="widget" data-widget_type="divider.default">
				<div class="elementor-widget-container">
					<div class="elementor-divider">
			<span class="elementor-divider-separator">
						</span>
				...
				<div class="elementor-element elementor-element-915dcdc elementor-widget elementor-widget-text-editor" data-id="915dcdc" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
							<p><span style="letter-spacing: var(--bodyletterspacing); text-transform: var(--bodytexttransform);">Now, however, if these notes were a more extensive conversation about my work, there would be more to say about the renunciation - painful and controversial as it is - of dialogue with the present of the art world. As already said, I needed time to give body and shape to my discussion on sculpture. I had to put together a certain number of works to propose myself in some exhibition or competition, however, over time, the wait was given up. I no longer looked for criticism, institutions, the market.</span> <br>Let's say that I am in another story - in another "scale of values" - not regarding the reasons for art, but towards the social, the market, which has become the first voice, if not the "cultural authority" of art itself.<br><span style="letter-spacing: var(--bodyletterspacing); text-transform: var(--bodytexttransform);">In short, I made sculpture for study, for research (or maybe just for myself), but I made sculpture. I made sculpture because I looked for my own story in that art. I looked for belonging in his story, an elective, sapiential resonance with which to dialogue... to create sculpture.</span></p>						</div>
				</div>
					</div>
		</div>
