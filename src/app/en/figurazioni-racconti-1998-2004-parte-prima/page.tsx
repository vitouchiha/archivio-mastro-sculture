...
export default function Pagefigurazioniracconti19982004parteprima() {
  return (
    <div className="wp-singular page-template page-template-page-templates page-template-template-pagebuilder-full-width page-template-page-templatestemplate-pagebuilder-full-width-php page page-id-4216 wp-theme-neve  nv-blog-default nv-sidebar-full-width menu_sidebar_slide_left elementor-default elementor-kit-14 elementor-page elementor-page-4216 nv-template">
...
<link rel="stylesheet" id="elementor-post-4216-css" href="/css/post-4216.css" media="all">
...
/*# sourceURL=/wp-includes/blocks/social-links/style.min.css */
 ...
 ` }} />
      <Script strategy="afterInteractive" src="/js/en/figurazioni-racconti-1998-2004-parte-prima-logic.js" />
...
<ul class="sub-menu">
	...
	<ul class="sub-menu">
		<li id="menu-item-4228" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-4216 current_page_item menu-item-4228 nv-active"><div class="wrap"><a href="/en/figurazioni-racconti-1998-2004-parte-prima/" aria-current="page">PART ONE</a></div></li>
...
<ul class="sub-menu">
	...
	<ul class="sub-menu">
		<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-4216 current_page_item menu-item-4228 nv-active"><div class="wrap"><a href="/en/figurazioni-racconti-1998-2004-parte-prima/" aria-current="page">PART ONE</a></div></li>
...
.elementor-column .elementor-spacer-inner{height:var(--spacer-size)}.e-con{--container-widget-width:100%}.e-con-inner>.elementor-widget-spacer,.e-con>.elementor-widget-spacer{width:var(--container-widget-width,var(--spacer-size));--align-self:var(--container-widget-align-self,initial);--flex-shrink:0}.e-con-inner>.elementor-widget-spacer>.elementor-widget-container,.e-con>.elementor-widget-spacer>.elementor-widget-container{height:100%;width:100%}.e-con-inner>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer,.e-con>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer{height:100%}.e-con-inner>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer>.elementor-spacer-inner,.e-con>.elementor-widget-spacer>.elementor-widget-container>.elementor-spacer>.elementor-spacer-inner{height:var(--container-widget-height,var(--spacer-size))}.e-con-inner>.elementor-widget-spacer.elementor-widget-empty,.e-con>.elementor-widget-spacer.elementor-widget-empty{position:relative;min-height:22px;min-width:22px}.e-con-inner>.elementor-widget-spacer.elementor-widget-empty .elementor-widget-empty-icon,.e-con>.elementor-widget-spacer.elementor-widget-empty .elementor-widget-empty-icon{position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;padding:0;width:22px;height:22px}</style>		<div class="elementor-spacer">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-d9777ac elementor-widget elementor-widget-spacer" data-id="d9777ac" data-element_type="widget" data-widget_type="spacer.default">
				<div class="elementor-widget-container">
					<div class="elementor-spacer">
			<div class="elementor-spacer-inner"></div>
		</div>
...
<strong>FIGURATIONS STORIES – part one</strong></p>
</td>
</tr>
</tbody>
</table>						</div>
    ...
    <title>Scheme</title>
       <style>   
                            ...
                            <tbody><tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="1" onclick="myBorder('1')">
                                        <img decoding="async" src="/images/FRX01.jpg" style="display:none;" id="img1" alt="01">
                                        <img decoding="async" style="width: 80px;" src="/images/FR01.jpg" onclick="myFunction('img1');">
                                    </div>
                                       
                                </td>
                                <td>
                                    <div class="column_img" id="2" onclick="myBorder('2')">   
										<img decoding="async" src="/images/FRX02.jpg" style="display:none;" id="img2" alt="02">
                                        <img decoding="async" style="width: 80px;" src="/images/FR02.jpg" onclick="myFunction('img2');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="3" onclick="myBorder('3')">   
										<img decoding="async" src="/images/FRX03.jpg" style="display:none;" id="img3" alt="03" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR03.jpg" onclick="myFunction('img3');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="4" onclick="myBorder('4')">   
										<img decoding="async" src="/images/FRX04.jpg" style="display:none;" id="img4" alt="04" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR04.jpg" onclick="myFunction('img4');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="5" onclick="myBorder('5')"> 
										<img decoding="async" src="/images/FRX05.jpg" style="display:none;" id="img5" alt="05" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR05.jpg" onclick="myFunction('img5');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="6" onclick="myBorder('6')">
                                        <img decoding="async" src="/images/FRX06.jpg" style="display:none;" id="img6" alt="06" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR06.jpg" onclick="myFunction('img6');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="7" onclick="myBorder('7')">
                                        <img decoding="async" src="/images/FRX07.jpg" style="display:none;" id="img7" alt="07" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR07.jpg" onclick="myFunction('img7');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="8" onclick="myBorder('8')">
                                        <img decoding="async" src="/images/FRX08.jpg" style="display:none;" id="img8" alt="08" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR08.jpg" onclick="myFunction('img8');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="9" onclick="myBorder('9')">
                                        <img decoding="async" src="/images/FRX09.jpg" style="display:none;" id="img9" alt="09" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR09.jpg" onclick="myFunction('img9');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="10" onclick="myBorder('10')">
                                        <img decoding="async" src="/images/FRX10.jpg" style="display:none;" id="img10" alt="10" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR10.jpg" onclick="myFunction('img10');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="11" onclick="myBorder('11')">
                                        <img decoding="async" src="/images/FRX11.jpg" style="display:none;" id="img11" alt="11" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR11.jpg" onclick="myFunction('img11');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="12" onclick="myBorder('12')">
                                        <img decoding="async" src="/images/FRX12.jpg" style="display:none;" id="img12" alt="12" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR12.jpg" onclick="myFunction('img12');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="13" onclick="myBorder('13')">
                                        <img decoding="async" src="/images/FRX13.jpg" style="display:none;" id="img13" alt="13" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR13.jpg" onclick="myFunction('img13');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="14" onclick="myBorder('14')">
                                        <img decoding="async" src="/images/FRX14.jpg" style="display:none;" id="img14" alt="14" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR14.jpg" onclick="myFunction('img14');">
                                    </div>
                                </td>
                            </tr>
                        </tbody></table>
                            ...
                            <tbody><tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="15" onclick="myBorder('15')">
                                        <img decoding="async" src="/images/FRX15.jpg" style="display:none;" id="img15" alt="15" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR15.jpg" onclick="myFunction('img15');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="16" onclick="myBorder('16')">
                                        <img decoding="async" src="/images/FRX16.jpg" style="display:none;" id="img16" alt="16" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR16.jpg" onclick="myFunction('img16');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="17" onclick="myBorder('17')">
                                        <img decoding="async" src="/images/FRX17.jpg" style="display:none;" id="img17" alt="17" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR17.jpg" onclick="myFunction('img17');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="18" onclick="myBorder('18')">
                                        <img decoding="async" src="/images/FRX18.jpg" style="display:none;" id="img18" alt="18" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR18.jpg" onclick="myFunction('img18');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="19" onclick="myBorder('19')">
                                        <img decoding="async" src="/images/FRX19.jpg" style="display:none;" id="img19" alt="19" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR19.jpg" onclick="myFunction('img19');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="20" onclick="myBorder('20')">
                                        <img decoding="async" src="/images/FRX20.jpg" style="display:none;" id="img20" alt="20" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR20.jpg" onclick="myFunction('img20');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="21" onclick="myBorder('21')">
                                        <img decoding="async" src="/images/FRX21.jpg" style="display:none;" id="img21" alt="21" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR21.jpg" onclick="myFunction('img21');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="22" onclick="myBorder('22')">
                                        <img decoding="async" src="/images/FRX22.jpg" style="display:none;" id="img22" alt="22" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR22.jpg" onclick="myFunction('img22');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_img" id="23" onclick="myBorder('23')">
                                        <img decoding="async" src="/images/FRX23.jpg" style="display:none;" id="img23" alt="23" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR23.jpg" onclick="myFunction('img23');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_img" id="24" onclick="myBorder('24')">
                                        <img decoding="async" src="/images/FRX24.jpg" style="display:none;" id="img24" alt="24" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR24.jpg" onclick="myFunction('img24');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_gri" id="25" onclick="myBorder('25')">
                                        <img decoding="async" src="/images/FRX25.jpg" style="display:none;" id="img25" alt="25" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR25.jpg" onclick="myFunction('img25');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_gri" id="26" onclick="myBorder('26')">
                                        <img decoding="async" src="/images/FRX26.jpg" style="display:none;" id="img26" alt="26" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR26.jpg" onclick="myFunction('img26');">
                                    </div>
                                </td>
                            </tr>
                            <tr height="80px" padding="0px" margin="0px" border="0px">
                                <td>
                                    <div class="column_gri" id="27" onclick="myBorder('27')">
                                        <img decoding="async" src="/images/FRX27.jpg" style="display:none;" id="img27" alt="27" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR27.jpg" onclick="myFunction('img27');">
                                    </div>
                                </td>
                                <td>
                                    <div class="column_gri" id="28" onclick="myBorder('28')">
                                        <img decoding="async" src="/images/FRX28.jpg" style="display:none;" id="img28" alt="28" onclick="myFunction(this);">
                                        <img decoding="async" style="width: 80px;" src="/images/FR28.jpg" onclick="myFunction('img28');">
                                    </div>
                                </td>
                            </tr>
                        </tbody></table>
            ...
            <table height="100px" padding="0px" margin="0px" style="width: 1000px; border: 0px;"> <!-- Tabella Riquadri Immagini-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-75725ef elementor-section-full_width sezionetitoli elementor-section-height-default elementor-section-height-default" data-id="75725ef" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-d108932" data-id="d108932" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-70594fa titoli_opere elementor-widget elementor-widget-text-editor" data-id="70594fa" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
1964-1977</a>						</div>
				...
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-b013982 colonnatitoli" data-id="b013982" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-c681a00" data-id="c681a00" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-e370a12 titoli_opere elementor-widget elementor-widget-text-editor" data-id="e370a12" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
1978-1985</a>						</div>
				...
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-fda60bb colonnatitoli" data-id="fda60bb" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-bd196d4" data-id="bd196d4" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-42885a0 titoli_opere elementor-widget elementor-widget-text-editor" data-id="42885a0" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
...
1986-1997</a>						</div>
				...
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-6968b12 colonnatitoli" data-id="6968b12" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-b52c3d3" data-id="b52c3d3" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-ce29582 titoli_opere elementor-widget elementor-widget-text-editor" data-id="ce29582" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
							<a href="/en/figurazioni-racconti-1998-2004-parte-seconda/">Figurations 
Stories<br>
1998-2004 II</a>						</div>
				</div>
					</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-4331a07 colonnatitoli" data-id="4331a07" data-element_type="column">
			<div class="elementor-widget-wrap">
							</div>
		</div>
				<div class="elementor-column elementor-col-11 elementor-top-column elementor-element elementor-element-9bfcfa2" data-id="9bfcfa2" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-d2a8121 titoli_opere elementor-widget elementor-widget-text-editor" data-id="d2a8121" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
