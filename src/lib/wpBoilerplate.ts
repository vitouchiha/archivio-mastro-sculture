// AUTO-GENERATED by extract-boilerplate.mjs - do not edit manually
// Shared WordPress/Elementor CSS boilerplate injected into every page.

export const WP_BOILERPLATE_BEFORE = `<style id="wp-img-auto-sizes-contain-inline-css">
...
export const WP_BOILERPLATE_AFTER = `
